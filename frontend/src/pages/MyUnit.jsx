...
function SectionLabel({ children }) {
  return (
    <div style={{ display: 'flex', alignItems: 'center', gap: 8, margin: '28px 0 14px' }}>
      <span style={{ width: 3, height: 18, borderRadius: 2, background: 'var(--teal-500)', flexShrink: 0 }} />
      <span style={{ fontSize: 12, fontWeight: 800, color: 'var(--teal-700)', textTransform: 'uppercase', letterSpacing: '0.08em' }}>
        {children}
      </span>
    </div>
  );
...
export default function MyUnit() {
  ...
  // ── Initial load (period-independent) ──────────────────────────────────
  useEffect(() => {
    if (!tenantId) return;
    setLoading(true);
    Promise.all([
  ...
  return (
    <div className="content-fade">
      ...
      {/* ════════════════════════ TU UNIDAD ════════════════════════════════ */}
      <SectionLabel>Tu Unidad</SectionLabel>
      ...
      {/* ── Divider + Period navigator ── */}
      <div style={{ height: 1, background: 'var(--sand-100)', margin: '32px 0 20px' }} />
      ...
      {/* ════════════════════════ ECONÓMICOS ═══════════════════════════════ */}
      <SectionLabel>Económicos</SectionLabel>

      {/* KPI Grid */}
      <div style={{ marginBottom: 6 }}>
        <div style={{ fontSize: 11, fontWeight: 800, color: 'var(--ink-400)', textTransform: 'uppercase', letterSpacing: '0.08em', marginBottom: 10 }}>KPI&apos;s Económicos</div>
        <div className="kpi-grid" style={{ marginBottom: 20 }}>
      ...
      {/* Gauges */}
      <div style={{ fontSize: 11, fontWeight: 800, color: 'var(--ink-400)', textTransform: 'uppercase', letterSpacing: '0.08em', marginBottom: 10 }}>Indicadores de Eficiencia</div>
      <div className="grid-2" style={{ marginBottom: 20 }}>
      ...
      {/* Composición + Estatus */}
      <div style={{ fontSize: 11, fontWeight: 800, color: 'var(--ink-400)', textTransform: 'uppercase', letterSpacing: '0.08em', marginBottom: 10 }}>Composición y Estatus</div>
      <div className="grid-2" style={{ marginBottom: 20 }}>
        <div className="card">
          <div className="card-head">
      ...
      {/* Balance Financiero */}
      <div style={{ fontSize: 11, fontWeight: 800, color: 'var(--ink-400)', textTransform: 'uppercase', letterSpacing: '0.08em', marginBottom: 10 }}>Balance Financiero del Período</div>
      <div className="card" style={{ marginBottom: 20 }}>
        <div className="card-body">
          {(() => {
            ...
            return (
              <div>
                ...
                {hasSaldos && (
                  <div style={{ marginTop: 16, paddingTop: 16, borderTop: '1px solid var(--sand-100)', display: 'flex', gap: 0 }}>
                    {[
      ...
      {/* Recuperación de deuda (solo si hay) */}
      {deudaTotal > 0 && (
        <>
          <div style={{ fontSize: 11, fontWeight: 800, color: 'var(--ink-400)', textTransform: 'uppercase', letterSpacing: '0.08em', marginBottom: 10 }}>Recuperación de Deuda</div>
          <div className="card" style={{ marginBottom: 20 }}>
            <div className="card-body">
